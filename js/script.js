...
document.addEventListener('DOMContentLoaded', async () => {
  if (!USER_ID) {
    // Landing page is already shown via inline script in index.html
    return;
  }
  applyTheme();
...
// ── Load Settings ───────────────────────────────────────────
// Baca dari /toko/{uid} (sesuai dengan tempat admin menyimpan data)
...
// ── Load Products ───────────────────────────────────────────
// FIX: baca dari /toko/{uid}/produk (subcollection) — sama dengan tempat admin menyimpan
